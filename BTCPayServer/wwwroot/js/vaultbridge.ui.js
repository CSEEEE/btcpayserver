...
var vaultui = (function () {
    ...
    */
    ...
    var VaultFeedbacks = {
        vaultLoading: new VaultFeedback("?", "Checking ZEUSPay Vault is running...", "vault-feedback1", "vault-loading"),
        ...
        noVault: new VaultFeedback("failed", "ZEUSPay Vault does not seem to be running, you can download it on <a target=\"_blank\" href=\"https://github.com/zeuspayments/BTCPayServer.Vault/releases/latest\">Github</a>.", "vault-feedback1", "no-vault"),
        ...
        bridgeConnected: new VaultFeedback("ok", "ZEUSPay successfully connected to the vault.", "vault-feedback1", "bridge-connected"),
        vaultNeedUpdate: new VaultFeedback("failed", "Your ZEUSPay Vault version is outdated. Please <a target=\"_blank\" href=\"https://github.com/zeuspayments/BTCPayServer.Vault/releases/latest\">download</a> the latest version.", "vault-feedback2", "vault-outdated"),
